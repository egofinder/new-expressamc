...
@section('content')
    <section class="bg-blue-100">
        <div class="pt-4 text-center text-4xl">
            Loans List
        </div>
        <br>
        <div class="rounded border border-blue-700 bg-blue-500 py-2 px-4 text-center font-bold text-white hover:bg-blue-700">
            <a href="loans/create">Create your loan</a>
        </div>
