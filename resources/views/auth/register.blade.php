    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="first_name" class="mt-1 block w-full" type="text" name="first_name" :value="old('name')"
                    required autofocus />

                <x-label for="last_name" :value="__('Last Name')" />

                <x-input id="last_name" class="mt-1 block w-full" type="text" name="last_name" :value="old('name')"
                    required autofocus />
            </div>
